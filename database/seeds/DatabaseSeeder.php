...
class DatabaseSeeder extends Seeder
{
     ...
     */
     private $arrayPeliculas = array(
		...
		array(
			...
			'rented' => false, 
			'synopsis' => 'El FBI busca a "Buffalo Bill", un asesino en serie que mata a sus víctimas, después de prepararlas minuciosamente y arrancarles la piel. Para poder atraparlo recurren a Clarice Starling, una brillante licenciada universitaria, experta en conductas psicópatas, que aspira a formar parte del FBI. Siguiendo las instrucciones de su jefe, Jack Crawford, Clarice visita la cárcel de alta seguridad donde el gobierno mantiene encerrado a Hannibal Lecter, antiguo psicoanalista y asesino, dotado de una inteligencia superior a la normal. Su misión será intentar sacarle información sobre los patrones de conducta de "Buffalo Bill".'
		),
		array(
    ...
    private $arrayUsuarios = array(
        array(
            'name' => 'Ivan Maldonado',
            'email' => 'ivanmaldonado@gmail.com',
            'password' => 'm3rc4d30'
        ),
        array(
            'name' => 'Xavier Llombart',
            'email' => 'xavierllombart@gmail.com',
            'password' => 'p4n3ll3ts'
        )
    );
